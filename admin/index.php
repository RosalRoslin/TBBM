  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        ...
        <li class="bg_ly"> <a href="transaction.php"> <i class="icon-inbox"></i><span class="label label-success">101</span>Transactions Details </a> </li> <li class="bg_lb"> <a href="contactdetails.php"> <i class="icon-envelope-alt"></i>Contact-mail </a> </li>
             
        <li class="bg_lo"> <a href="tables.php"> <i class="icon-th"></i> Users Info</a> </li>
        <li class="bg_ls"> <a href="grid.html"> <i class="icon-fullscreen"></i> Full width</a> </li>
        <li class="bg_lo span3"> <a href="tickets.php"> <i class="icon-th-list"></i> Tickets Details</a> </li>
