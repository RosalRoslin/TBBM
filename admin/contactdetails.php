...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Contact Details</a> </div>
...
<?php
      ...
      ?>
      <tr class="table-row" id="row-<?php echo $row["contactid"]; ?>"> 
        <td class="table-row"><?php echo $row["contactid"]; ?></td>
        <td class="table-row"><?php echo $row["firstname"]; ?></td>
        <td class="table-row"><?php echo $row["email"]; ?></td>
        <td class="table-row"><?php echo $row["website"]; ?></td>
        <td class="table-row"><?php echo $row["message"]; ?></td>
        <td class="table-row"><?php echo $row["msgtime"]; ?></td>
